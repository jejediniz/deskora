  ...
  return (
    <div className="mx-auto max-w-[920px] px-4 pb-20 pt-4 text-od-text" aria-busy="true">
      <div className="mb-6 flex gap-2">
        ...
        <div className="h-10 w-28 animate-pulse rounded-xl bg-od-border/30 dark:bg-od-surface-muted" />
      </div>
      <div className="mb-6 h-40 animate-pulse rounded-2xl bg-od-border/30 dark:bg-od-surface-muted" />
      <div className="space-y-4">
        {["a", "b", "c"].map((k) => (
          <div key={k} className="h-32 animate-pulse rounded-2xl bg-od-border/30 dark:bg-od-surface-muted" />
        ))}
      </div>
    </div>
  );
